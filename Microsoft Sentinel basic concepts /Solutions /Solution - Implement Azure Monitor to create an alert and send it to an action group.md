...
1. Download the **az-11-vm-template.json** lab files to your computer.
...
1. Locate and select the **az-11-vm-template.json** file and select **Open**.
...
1. Use the following information to complete the custom deployment fields, leaving all other fields with their default values:
    ...
    | Resource group| `az-rg11` (If necessary, select **Create new**)
    | Region        | **East US**   |
    | Username      | `localadmin`   |
...
1. Check the box for the **az-vm0** virtual machine.
